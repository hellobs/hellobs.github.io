  ...
  var I18N = {
    zh: {
      ...
      hero:{
        ...
        desc:"用交互设计感知问题，用工程与算法构建答案。HAIDE Lab 学生成员，深耕人机交互、多智能体仿真与智能算法。",
        ctaView:"浏览作品", ctaContact:"联系我",
        m1n:"2", m1l:"在研多智能体课题", m2n:"HAIDE", m2l:"HAIDE Lab 学生成员", m3n:"SCUT", m3l:"华南理工大学"
      },
      about:{
        title:"关于 · About",
        lead:"华南理工大学 工业设计实验班（信息与交互设计），辅修计算机科学与技术；HAIDE Lab 学生成员，扎根人机交互与多智能体仿真研究的交叉地带。",
        tMajor:"主修", major:"工业设计 · 信息与交互设计",
        tMinor:"辅修", minor:"计算机科学与技术",
        tResearch:"科研", research:"HAIDE Lab · 多智能体仿真 × 人机交互 （MetaEvo Lab）",
        resume:"下载简历 PDF",
      ...
      p1:{year:"2026 – 在研",ongoing:"在研",title:"Provenance · AI 价值形成多智能体仿真平台",role:"HAIDE Lab · 项目成员",desc:"开发多智能体仿真平台，通过可溯源、可配置的多方决策，直观可视化 AI 价值（价值观）的形成与演化过程，支撑 AI 治理研究。"},
      p2:{year:"2026 – 在研",ongoing:"在研",title:"MAVIS · 可控可解释多智能体仿真框架",role:"HAIDE Lab · 框架开发",desc:"构建可控、可解释的多智能体仿真框架：建模复杂人机交互、追踪智能体决策轨迹，并为 AI 治理场景提供可解释的评估支持。"},
      p3:{year:"2026.3 – 进行中",ongoing:"进行中",title:"SRP · 低空无人机三维仿真训练平台",role:"设计学院 SRP 项目 · 核心开发者",desc:"基于 Unity 从零搭建低空无人机三维仿真训练平台，借助 AI 工具完成飞控、搜索救援、武器发射等模块；引入桥接等设计模式组织架构，并负责团队 Git 仓库搭建与维护。"},
      p4:{year:"2026.7 – 进行中",ongoing:"进行中",title:"Global Trust Challenge · 全球数字可信挑战赛",role:"原型开发与 Unity 可视化",desc:"Generative Agents 多智能体文献研读，同步学习 FastAPI 后端，调研仿真平台与后端通信方案与完整交互仿真场景。"},
      skills:{
        title:"技能栈 · Skills",
    ...
    en: {
      ...
      hero:{
        ...
        desc:"Perceive problems through interaction design, build answers through engineering and algorithms. Student at HAIDE Lab, focusing on human-AI interaction, multi-agent simulation and intelligent algorithms.",
        ctaView:"View Works", ctaContact:"Contact",
        m1n:"2", m1l:"Active research projects", m2n:"HAIDE", m2l:"Student at HAIDE Lab", m3n:"SCUT", m3l:"South China Univ. of Tech."
      },
      about:{
        title:"About",
        lead:"South China University of Technology — Industrial Design Experimental Class (Information & Interaction Design), minor in Computer Science & Technology; student at HAIDE Lab, working at the intersection of human-AI interaction and multi-agent simulation.",
        tMajor:"Major", major:"Industrial Design · Info & Interaction",
        tMinor:"Minor", minor:"Computer Science & Technology",
        tResearch:"Research", research:"HAIDE Lab · multi-agent simulation × HCI (MetaEvo Lab)",
      ...
      p3:{year:"2026.3 – Ongoing",ongoing:"Ongoing",title:"SRP · Low-Altitude Drone Simulation Platform",role:"Core Developer · School of Design SRP",desc:"Built a 3D drone simulation training platform from scratch in Unity, prototyping flight control, search & rescue, and weapon modules with AI-assisted development; applied bridge and other design patterns to architecture and set up the team Git repository."},
      p4:{year:"2026.7 – Ongoing",ongoing:"Ongoing",title:"Global Trust Challenge",role:"Prototype + Unity Visualization",desc:"Researching Generative Agents multi-agent literature, learning the FastAPI backend, and investigating simulation-backend communication and full interactive scenarios."},
      skills:{
        title:"Skills",
